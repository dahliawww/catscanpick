    ...
    <div className="w-full">
      <div className="relative w-full">
        <input
          ...
          className="w-full py-3 pl-12 pr-4 text-[#333333] transition-all duration-200 bg-white border-2 border-gray-300 shadow-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-gold focus:border-brand-gold"
        />
